...
> **Strateginen valinta:** Kaikki kiinteät suojat on poistettu ajotakeista ja -housuista pakkaustilavuuden minimoimiseksi (~2,3 kg säästö kuorivaatteissa). Kaikkien ajovarusteiden alla käytetään poikkeuksetta Rukan RPS-suojapaitaa ja -suojahousuja, jolloin suojaustaso pysyy maksimaalisena (Level 2) ja suojat istuvat aina täydellisesti paikoillaan.

---

## 0. Reissun Ratsu & Pakkausratkaisu (Moottoripyörä)
...
### Kiinteä Suojakerros (Käytetään AINA ajossa alimmaisena)
* **Rukka RPS AFT -suojapaita**
  * D3O® Air XTR All back -selkäsuoja (CE EN 1621-2:2014, LVL 2)
  * D3O® LP2 -olka- ja kyynärsuojat (CE EN 1621-1 2012, LVL 2)
  * D3O® CP1 -rintasuoja (CE EN 1621-3 2018, LVL 1)
* **Rukka suojahousut RPS AFT**
  * D3O® LP2 Pro -lonkka- ja polvisuojat (CE EN 1621-1 2012, LVL 2)

### Ajokuoret (Ilman omia suojia)
* **Kylmälle säälle / Sateelle: Rukka Armatou-R -takki (Koko 56)** (Huipputason Gore-Tex Pro -laminaatti. Pitää tuulen ja sateen täysin ulkopuolella. Koko 56 jättää loistavasti tilaa RPS-suojapaidalle ja välikerroksille.)
* **Kylmälle säälle / Sateelle: Rukka Armatou-R -housut (Koko 56 Short)** (Gore-Tex Pro -laminaattihousut Armacor-vahvikkeilla. Pakkautuu erittäin pieneen tilaan ilman omia suojiaan.)
* **Kuumalle säälle: Rukka Airtacama -housut (Koko 54 Short)** (Täysiveriset verkkohousut, vedetään suoraan RPS-suojahousujen päälle helteellä.)
...
* **Ajohanskat & Päällyssuojat:**
  ...
  * **LS2 Thermorain -sade- & lämpöhanskat** (Veden- ja tuulenpitävät päällyshanskat, jotka voidaan vetää muiden ajohanskojen päälle tuomaan lisäeristystä ja täydellistä sadesuojaa)
...
* **Icon Stormhawk WP -moottoripyöräsaappaat** (Vedenpitävät nahkakengät Michelin-pohjalla)

---

## 2. Välikerrokset & Siviilivaatteet (Ilman motskaa / Ajoon)

* **Haglöfs Mid Slim Pant** (Koko 56 Short. Kevyet, ohuet retkeilyhousut. Voidaan käyttää siviilissä tai kylmällä säällä RPS-suojahousujen ja Armatou-R-kuorihousujen välissä lisäeristeenä.)
* **Devold Lauparen Merino 190 Zip Neck Man** (Koko L. Korkealaatuinen merinovillapaita, jota käytetään joko RPS-suojapaidan alla ihoa vasten tai siviilissä.)
* **Devold Lauparen Merino 190 Longs Man** (Koko L. Pitkä merinovillakalsari, käytetään RPS-suojahousujen alla kylmällä kelillä.)
* **Vihreä väli-fleece / Särmä merinohuppari** (Paksu, lämmin välikerros tuomaan eristystä RPS-suojapaidan ja Armatou-R -takin väliin.)
...
### Majoitus
* **MSR Mutha Hubba NX 3 -teltta** (Kolmen hengen tilava ja kevyt kupoliteltta)
* **MSR Mutha Hubba NX 3 Footprint** (Lisämaavaate suojaamaan teltan pohjaa)
* **Armystyle-makuupussi** (Yökäyttöön leirissä + ohuen ohut silkkilakana)
* **Yuzonc Sleeping Mat** (Kahden hengen paksu täytettävä retkipatja integroidulla jalkapumpulla, leveys 1.36 m)
* **Retkipyyhe + uikkarit**

### Keittiö & Kahvittelu
* **Soto WindMaster -retkikeitin & Primus PrimeTech 1.3 L -kattila** (Painoanalyysi: Pelkkä keitin ja kattilarunko **352 g**)
* **230 g Primus Power Gas -retkikaasu** (Pakkautuu keittimen kanssa suoraan kattilan sisään, yhteispaino **734 g**)
* **AeroPress Go Plus** (Premium-tason matkakahvijärjestelmä integroidulla terästermosmukilla. Painoanalyysi: **557 g**)

### Leiriytyminen & Selviytyminen
* **Sawyer MINI -vedensuodatin (Pakkauksineen)** (Ultrakevyt 0.1 mikronin kuitusuodatin. Painoanalyysi: Pelkkä suodatin **~39 g**, koko setti **~100 g**)
...
* **Ylävartalo:** Devold Lauparen Merino 190 Zip Neck + **Rukka RPS -suojapaita** + Rukka Armatou-R -takki (ilman omia suojiaan).
* **Alavartalo:** Devold-merinoboxerit + **Rukka RPS -suojahousut** + Rukka Armatou-R -housut (ilman omia suojiaan).
* **Jalkineet & Kädet:** Icon Stormhawk WP + merinosukat + nahkaiset perushanskat.
...
* **Ylävartalo:** Särmä vaarinpaita + Devold Lauparen Merino Zip Neck + **Rukka RPS -suojapaita** + Fleece/Merinohuppari + Rukka Armatou-R -takki + Kypärähuppu ja kauluri.
* **Alavartalo:** Devold Lauparen Merino 190 Longs + **Rukka RPS -suojahousut** + Haglöfs Mid Slim Pant + Rukka Armatou-R -housut.
* **Jalkineet & Kädet:** Vuorimerinosukat + Sealskinz-kalvosukat + Lämpimät vedenpitävät hanskat + **LS2 Thermorain -päällyshanskat** + kahvanlämmittimet täysille.
